    ...
    <main>
      <nav>
        ...
        <div className="nav-right">
          <a href="#assessment">Symptom guide</a>
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <p>
            Use a thoughtful symptom guide, record how you feel, and get clear
            next-step guidance—without replacing your clinician.
          </p>
          <a className="hero-button" href="#assessment">
            Check symptoms <ArrowRight size={18} />
          </a>
          <div className="trust">
            <ShieldCheck size={17} /> Private by design · Built for guidance, not
            diagnosis
          </div>
        </div>
      ...
      <section className="safety-strip">
        ...
        <span>
          ...
          difficulty, stroke symptoms, loss of consciousness, or feel unsafe,
      ...
      <section className="assessment section" id="assessment">
        <div className="section-intro">
          ...
          <div className="privacy-note">
            <ShieldCheck size={17} /> Nothing is saved unless you choose to save
            it.
          </div>
        </div>
        ...
        <div className="principle-list">
          <article>
            ...
            <div>
              ...
              <p>
                Our guide prioritizes urgent warning signs and encourages timely
                professional care.
              </p>
            </div>
          </article>
          <article>
            ...
            <div>
              ...
              <p>
                Symptoms overlap. Vitalis helps you organize information, but it
          ...
          <article>
            ...
            <div>
              ...
              <p>
                Your saved entries belong to your account and are protected by
      ...
      <footer>
        ...
        <p>© {new Date().getFullYear()} Vitalis Health</p>
      </footer>
